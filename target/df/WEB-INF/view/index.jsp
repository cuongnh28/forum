...
<%@ include file="header.jsp" %>
	...
	<div class="main w clearfix">
			...
			<div class="post">
				<div class="post-wrap">
					<div class="post-choice">
                        <a href="listPostByNewestTime.do?curPage=${pageBean.curPage }" class="post-choice-current">Newest</a>
		...
		<div class="main-right">
			...
			<div class="hot-user">
				<div class="clearfix"><div class="hot-user-title"><span></span>&nbsp;Hot Users</div></div>
